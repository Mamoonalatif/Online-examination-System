...
if menu == "Manage Questions":
    ...
    if not questions_df.empty:
        ...
        with st.form("modify_delete_form"):
            ...
            # Ensure the selected subject is in the subjects_data list before setting the index
            selected_subject = selected_question["Subject"]
            if selected_subject not in subjects_data:
                selected_subject = subjects_data[0]  # Set to a default value if not found
        ...
        st.write("No questions available to modify or delete.")
